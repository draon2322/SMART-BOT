  ...
  console.log(`Logged in as ${client.user.tag}!`);
         ...
         client.on('message', message => {
            if (message.content === '+invite') {
              message.channel.send('https://discordapp.com/api/oauth2/authorize?client_id=480568290352168980&permissions=8&scope=bot');
 ...
 if (msg.content.startsWith(prefix + 'send')) {
  ...
  client.on('message', msg => {//msg
    if (msg.content === 'السلام عليكم') {
      msg.chanel.send({file : "رابط الصورة الي تبي يرد فيه"})
    }
  });;
...
client.on('message', function(msg) {
    const prefix = #
    if(msg.conten.startsWith (prefix  + 'server')) {
